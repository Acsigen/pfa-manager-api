...
async def show_activity_report_handler(
    user: user_dependency, client_id: int, contract_id: int, wo_id: int, ar_id: int
):
...
async def list_activity_reports_handler(
...
async def delete_activity_report_handler(
    user: user_dependency, client_id: int, contract_id: int, wo_id: int, ar_id: int
):
    if (
        delete_activity_report(
