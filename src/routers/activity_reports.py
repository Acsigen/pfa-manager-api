...
async def add_activity_report_handler(user: user_dependency, wo_id: int, activity_report: ActivityReport):
    added_activity_report: ActivityReport = activity_report.add(wo_id=wo_id, user_id=user.get("user_id"))
...
async def update_activity_report_handler(user: user_dependency, wo_id: int, ar_id: int, activity_report: ActivityReport):
    updated_activity_report: ActivityReport = activity_report.update(wo_id=wo_id,ar_id=ar_id, user_id=user.get("user_id"))
...
async def show_activity_report_handler(user: user_dependency, wo_id: int, ar_id: int):
    activity_report: ActivityReport = show_activity_report(wo_id=wo_id, activity_report_id=ar_id, user_id=user.get("user_id"))
...
async def list_activity_reports_handler(user: user_dependency, wo_id: int):
    contract_list: list[ActivityReport] = list_activity_reports(wo_id=wo_id, user_id=user.get("user_id"))
...
async def delete_activity_report_handler(user: user_dependency, wo_id: int, ar_id: int):
    if delete_activity_report(wo_id=wo_id, activity_report_id=ar_id, user_id=user.get("user_id")) is True:
